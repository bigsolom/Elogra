...
class Elogra_PusherInstance {
	...
	public static function get_pusher()
	{
		...
		self::$instance = new Elogra_Pusher(
			self::$api_key, 
			self::$secret, 
			self::$app_id
		);
...
class Elogra_Pusher
{
	...
	*/
	...
	{	
		...
		$string_to_sign = "$request_method\n" . $request_path . "\n" . Elogra_Pusher::array_implode( '=', '&', $params );
		...
		$auth_query_string = Elogra_Pusher::array_implode( '=', '&', $params );
  ...
  public static function array_implode( $glue, $separator, $array ) {
	...
	*/
	public function trigger( $channel, $event, $payload, $socket_id = null, $debug = false, $already_encoded = false )
	{
		...
		$signed_query = Elogra_Pusher::build_auth_query_string(
